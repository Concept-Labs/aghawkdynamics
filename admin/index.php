...
<head>
	...
	<!-- uploader -->
	<script src="_upload.js?t=<?php echo time(); ?>"></script>
...
<header id="masthead" class="site-header " role="banner">
	<div class="pad">
		<h1 id="hdrLogo" class="site-title">
			<a href="./">
				<img src="images/admin-logo.png" border="0">
				<div class="text">
					AG<span>HAWK</span>
					<span class="smaller">ADMINISTRATION <span>DASHBOARD</span></span>
				</div>
			</a>
		</h1>
		
		<div class="hdrUser">
			Welcome, <? echo $_SESSION['first_name']; ?> | <a href="?logout">Logout</a>
		</div>
			...
			<nav id="site-navigation" class="primary-navigation" aria-label="Primary menu">
				...
				<div id="mega-menu-wrap-primary" class="mega-menu-wrap">
					...
					<ul id="mega-menu-primary" class="mega-menu max-mega-menu mega-menu-horizontal" data-event="hover_intent" data-effect="fade_up" data-effect-speed="200" data-effect-mobile="disabled" data-effect-speed-mobile="0" data-mobile-force-width="false" data-second-click="go" data-document-click="collapse" data-vertical-behaviour="standard" data-breakpoint="890" data-unbind="true" data-mobile-state="collapse_all" data-hover-intent-timeout="300" data-hover-intent-interval="100">
						<li class="mega-menu-item  mega-menu-item-home mega-current-menu-item mega-page_item mega-page-item-2 mega-current_page_item  mega-menu-flyout"><a class="mega-menu-link" href="index.php">Home</a></li>
						
						<li class="mega-menu-item  mega-menu-item-has-children  mega-menu-flyout"><a class="mega-menu-link" href="?view=accounts" aria-haspopup="true" aria-expanded="false">Accounts<span class="mega-indicator" data-has-click-event="true"></span></a>
							<ul class="mega-sub-menu">
								<li class="mega-menu-item"><a class="mega-menu-link" href="?view=account_add">Add Account</a></li>
							</ul>
						</li>
												
						<li class="mega-menu-item  mega-menu-item-has-children  mega-menu-flyout"><a class="mega-menu-link" href="?view=service_requests" aria-haspopup="true" aria-expanded="false">Service Requests<span class="mega-indicator" data-has-click-event="true"></span></a>
							<ul class="mega-sub-menu">
								<li class="mega-menu-item "><a class="mega-menu-link" href="?view=service_request_add">Create Service Request</a></li>
								<li class="mega-menu-item "><a class="mega-menu-link" href="?view=recurring_services">Recurring Services</a></li>
							</ul>
						</li>
						
						<li class="mega-menu-item   mega-menu-flyout"><a class="mega-menu-link" href="?view=admin_users">Admin Users</a></li>
					</ul>
				</div>
			</nav>
			<!-- #site-navigation --> 
...
<div id="page" class="site <?php echo $post_slug; ?>">
	<div id="content" class="site-content">
		...
		<? 
		if(!isset($_GET['view'])) {
			echo "<div class='homePlaceholderText'>
					<p>For now, we're displaying Accounts info on the Admin home page.</p>
					<p>We can discuss what content would be most useful here...</p>
				  </div>\n\n";
		
		}
		
		//determine what file to load into .adminPanel below
		$views = [
			"accounts" => "accounts.php",
			"account_add" => "account_add.php",
			"account_view" => "account_view.php",
			"account_edit" => "account_edit.php",
			"account_user_edit" => "account_user_edit.php",
			"account_user_add" => "account_user_add.php",
			"parcel_edit" => "parcel_edit.php",
			"parcel_add" => "parcel_add.php",
			"block_edit" => "block_edit.php",
			"block_add" => "block_add.php",
			"service_requests" => "service_requests.php",
			"service_request_add" => "service_request_add.php",
			"service_request_edit" => "service_request_edit.php",
			"recurring_services" => "recurring_services.php",
			"recurrence_edit" => "recurrence_edit.php",
			"recurrence_end" => "recurrence_end.php",
			"admin_users" => "admin_users.php"
		];

		$view = $_GET['view'] ?? 'accounts';
		$panel = $views[$view] ?? 'accounts.php';
		?>
