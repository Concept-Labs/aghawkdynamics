...
$service_request_id = isset($_GET['id']) ? intval($_GET['id']) : null;
...
<section class="adminSection">
	...
	<br />
	<p class="serviceRequestEditAcctInfo">
		<em>Account:</em> <a href="?view=account_view&id=<? echo $service_request['account_id']; ?>"><? echo htmlspecialchars($account['business_name']); ?></a><br />
		<em>Parcel:</em> <? echo htmlspecialchars($parcel['nickname']); ?><br />
		<em>Block:</em> <? echo htmlspecialchars($block['nickname']); ?>
	</p>

    <form method="POST">
        <table>
            <tr>
                <td><label><strong>Reason for Application:</strong></label></td>
                <td><input type="text" name="reason_for_application" value="<?php echo htmlspecialchars($service_request['reason_for_application']); ?>" required></td>
            </tr>
            <tr>
                <td><label><strong>Type of Service:</strong></label></td>
                <td>
            ...
            <tr>
                <td><label><strong>Type of Product:</strong></label></td>
                <td>
            ...
            <tr id="type_of_product_other_row" style="display:none;">
                <td><label><strong>Other Type of Product:</strong></label></td>
                <td><input type="text" name="type_of_product_other" id="type_of_product_other" value="<?php echo htmlspecialchars($service_request['type_of_product_other']); ?>"></td>
            </tr>
            <tr>
                <td><label><strong>Product Name:</strong></label></td>
                <td><input type="text" name="product_name" value="<?php echo htmlspecialchars($service_request['product_name']); ?>"></td>
            </tr>
            <tr>
                <td><label><strong>Supplier Name:</strong></label></td>
                <td><input type="text" name="supplier_name" value="<?php echo htmlspecialchars($service_request['supplier_name']); ?>"></td>
            </tr>
            <tr>
                <td><label><strong>Supplier Contact:</strong></label></td>
                <td><input type="text" name="supplier_contact_phone" value="<?php echo htmlspecialchars($service_request['supplier_contact_phone']); ?>"></td>
            </tr>
            <tr>
                <td><label><strong>Application Need By Date:</strong></label></td>
                <td><input type="date" name="application_need_by_date" value="<?php echo htmlspecialchars($service_request['application_need_by_date']); ?>" required></td>
            </tr>
            <tr>
                <td><label><strong>Scheduled Application Date:</strong></label></td>
                <td><input type="date" name="scheduled_date" value="<?php echo htmlspecialchars($service_request['scheduled_date']); ?>" required></td>
            </tr>
            <tr>
                <td><label><strong>Service Completed?</strong></label></td>
                <td><select name="status_completed" id="status_completed">
            ...
            <tr>
                ...
                <td><textarea name="comments"><?php echo htmlspecialchars($service_request['comments']); ?></textarea></td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    <button type="submit">Update Service Request</button>
                    <a href="?view=service_requests">Cancel</a>
                </td>
            </tr>
        </table>
    </form>
...
document.addEventListener('DOMContentLoaded', function() {
    var type_of_product = document.getElementById('type_of_product');
	if(type_of_product == 'Other') {
